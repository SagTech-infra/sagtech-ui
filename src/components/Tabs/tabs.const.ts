...
export const TRIGGER_ACTIVE = "bg-pr_purple border-pr_purple text-white_4";

export const TRIGGER_INACTIVE =
  "border-grey_4 text-grey_4 hover:border-white_4 hover:text-white_4";

export const TRIGGER_DISABLED =
  "border-grey_4 text-grey_4 opacity-40 cursor-not-allowed pointer-events-none";
