...
function ToastIcon({ variant }: { variant: ToastVariant }) {
  if (variant === 'success') {
    return (
      <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true" className="flex-shrink-0 text-success">
  ...
  if (variant === 'error') {
    return (
      <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true" className="flex-shrink-0 text-error">
        <circle cx="10" cy="10" r="9" stroke="currentColor" strokeWidth="1.5" />
  ...
  if (variant === 'warning') {
    return (
      <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true" className="flex-shrink-0 text-warning">
  ...
  if (variant === 'loading') {
    return (
      <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true" className="flex-shrink-0 text-grey_4 animate-spin">
  ...
  if (variant === 'info') {
    return (
      <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true" className="flex-shrink-0 text-pr_blue">
        <circle cx="10" cy="10" r="9" stroke="currentColor" strokeWidth="1.5" />
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <div className="font-semibold leading-18 break-words">{toast.message}</div>
        {toast.description && (
