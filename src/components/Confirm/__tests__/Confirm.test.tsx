...
describe('ConfirmDialog (declarative)', () => {
  ...
  it('calls onConfirm when the primary button is clicked', () => {
    const spy = vi.fn();
    render(<ConfirmDialog open onOpenChange={() => {}} title="x" onConfirm={spy} />);
...
describe('useConfirm() imperative API', () => {
  function Probe({
    ...
    options?: Parameters<ReturnType<typeof useConfirm>>[0] extends infer O ? Partial<O> : never;
  }) {
