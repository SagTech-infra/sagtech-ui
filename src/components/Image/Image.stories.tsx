...
export const Loading: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      ...
      <Image alt="Loading state" className="relative w-[400px] h-[300px]" />
    </div>
  ),
};
  ...
  render: () => (
    <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
      <div>
        ...
        <Image url={placeholderSvg} alt="Loaded" className="relative w-[200px] h-[150px]" objectFit="cover" />
      </div>
      <div>
        <p className="text-grey_2 font-manrope text-12 mb-8px">Loading (no URL)</p>
        <Image alt="Loading" className="relative w-[200px] h-[150px]" />
      </div>
      <div>
        <p className="text-grey_2 font-manrope text-12 mb-8px">Error (bad URL)</p>
        <Image url="https://bad.url/img.png" alt="Error" className="relative w-[200px] h-[150px]" />
      </div>
    </div>
  ),
};
