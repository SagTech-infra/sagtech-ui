const buttonConst = {
  basicStyles: 'leading-24 flex justify-center items-center gap-8px font-bold rounded-[16px] cursor-pointer',
  ...
  tabButtonWhiteBase:
    'leading-24 flex justify-center items-center gap-8px text-14 px-16px py-7px rounded-[50px] transition-all duration-800',
  tabButtonWhiteHover: 'tabButtonWhite hover:border-white hover:bg-white',
};
