const buttonConst = {
  ...
  tabButtonDefault:
    'text-fg-secondary  border-[1px] border-solid border-grey_4 rounded-[50px] transition-all duration-800',
  tabButtonActive: 'bg-pr_purple border-[1px] border-solid border-pr_purple text-white',
  tabButtonDisabled:
    'disabled:border-[1px] disabled:border-solid disabled:border-grey_2 disabled:bg-none disabled:text-fg-muted',
  ...
  primaryDisabledStyles: 'disabled:bg-[#545259] disabled:text-fg-muted',
  secondaryDisabledStyles: 'disabled:border-grey_2 disabled:text-fg-muted',
  loadingPrimary: 'bg-[#545259] text-fg-muted cursor-not-allowed',
  loadingSecondary: ' border-[2px] border-solid border-grey_2 text-fg-muted cursor-not-allowed',
  secondaryButton: 'border-[2px] border-solid border-border-strong bg-none text-fg-primary',
  tabButtonHover:
    'hover:border-white_4 hover:text-fg-primary hover:bg-white/5 hover:transition-all hover:duration-800',
  ...
  dangerDisabledStyles: 'disabled:bg-[#545259] disabled:text-fg-muted',
  loadingDanger: 'bg-[#545259] text-fg-muted cursor-not-allowed',
  tabButtonWhiteBase:
    'leading-24 flex justify-center items-center gap-8px text-14 px-16px py-7px rounded-[50px] cursor-pointer disabled:cursor-not-allowed transition-all duration-800',
